...
default_recipients = [admin[1] for admin in settings.ADMINS]
...
class Emailer(object):
    def __init__(self, subject='', message='', from_email=settings.EMAIL_FROM, recipient_list=default_recipients, email_template=None, context=None):
